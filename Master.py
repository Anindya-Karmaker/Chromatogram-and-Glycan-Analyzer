...
class Ui_MainWindow(object):
    ...
    def license_info(self):
        msg=QMessageBox(QMessageBox.Information,"Developer Information", "Software developed by Anindya Karmaker. Based on initial coding by Kevin Yates . Checkout the <a href='https://github.com/Anindya-Karmaker/Chromatogram-and-Glycan-Analyzer/'>GitHub</a> link for more updates.  Disclaimer: The software cannot guarantee the accuracy of the data and the developer claims no responsiblity. Please verify the data before publishing the output data from this software.")
        msg.exec_()
